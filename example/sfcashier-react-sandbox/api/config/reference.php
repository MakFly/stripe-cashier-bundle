 ...
 * }
 * @psalm-type CashierConfig = array{
 *     key?: scalar|Param|null, // Stripe API key // Default: "%env(default:pk_test_change_me:STRIPE_KEY)%"
 *     secret?: scalar|Param|null, // Stripe API secret // Default: "%env(default:sk_test_change_me:STRIPE_SECRET)%"
 *     path?: scalar|Param|null, // Base path for Stripe routes // Default: "cashier"
 *     webhook?: array{
 *         secret?: scalar|Param|null, // Webhook signing secret for verification // Default: "%env(default:whsec_change_me:STRIPE_WEBHOOK_SECRET)%"
 *         tolerance?: int|Param, // Webhook timestamp tolerance in seconds // Default: 300
 *         events?: list<scalar|Param|null>,
 *     },
 *     currency?: scalar|Param|null, // Default currency for payments // Default: "usd"
 *     currency_locale?: scalar|Param|null, // Locale for currency formatting // Default: "en"
 *     default_subscription_type?: scalar|Param|null, // Default subscription type for webhook-created subscriptions // Default: "default"
 *     invoices?: array{
 *         renderer?: scalar|Param|null, // Invoice renderer service class // Default: "CashierBundle\\Service\\InvoiceRenderer\\DompdfInvoiceRenderer"
 *         default_locale?: scalar|Param|null, // Default locale for invoice rendering // Default: "en"
 *         supported_locales?: list<scalar|Param|null>,
 *         storage?: array{
 *             driver?: scalar|Param|null, // Invoice storage driver // Default: "local"
 *             path?: scalar|Param|null, // Absolute path for persisted invoices // Default: "%kernel.project_dir%/var/data/invoices"
 *         },
 *         options?: array{
 *             paper?: scalar|Param|null, // Paper size for invoice PDF // Default: "letter"
 *             remote_enabled?: bool|Param, // Enable remote resources in invoice PDF // Default: false
 *         },
 *     },
 *     logger?: scalar|Param|null, // Logger service ID (default: null) // Default: null
 * }
